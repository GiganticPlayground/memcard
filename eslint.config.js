...
export default [
  ...
  // Configuration for TypeScript files
  {
    ...
    rules: {
      ...
      // TypeScript already checks for undefined globals/types; the core rule
      // produces false positives for Web/Node platform globals (URL, fetch,
      // AbortSignal, timers, ...). Disabled per typescript-eslint guidance.
      'no-undef': 'off',
  ...
  // Test files: node:test's describe/it/beforeEach return promises that the
  // runner manages, so floating-promise rules are noise here.
  {
    files: ['tests/**/*.ts'],
    rules: {
